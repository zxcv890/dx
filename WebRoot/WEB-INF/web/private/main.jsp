...
<style>
 ...
 <div class="weui_btn_area" ${noact}>
    <a class="weui_btn weui_btn_primary" href="javascript:act();">签到　(第${count}天)</a>
</div> 
<!--BEGIN dialog2-->
...
<div id="toast" style="display: none;">
    ...
    <div class="weui_toast">
        ...
        <p class="weui_toast_content">签到+<span id='num'></p>
    </div>
</div>
<!--end toast-->
<!-- loading toast -->
...
<script>
	...
	$(function(){
		...
		for ( var z = 0; z < 10; z++ ){
			...
			for ( var d = 0; d < 7; d++ ){
				...
				zhou += addday(item[index].id, item[index].day,item[index].pday, item[index].act, item[index].curr, item[index].s);
			}
			zhou += "</div>";
	...
	function addday( id, one, two, act, curr, s ){
		var html = "<div class='mate' onclick='info(" + id + ");'><div>";
		html += "<p class='one'>" + one + "</p><p class='two'>" + two + "</p>";
	...
	function info(id){
		window.location.href='/wxactday/info?id=' + id;
	}
